...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: '/vk-logo.png?v=7', sizes: 'any', type: 'image/png' },
    ],
    apple: [
      { url: '/vk-logo.png?v=7', sizes: '180x180', type: 'image/png' },
    ],
  ...
  return (
    <html lang="nl">
      <head>
        ...
        <link rel="icon" type="image/png" sizes="any" href="/vk-logo.png?v=7" />
        <link rel="apple-touch-icon" sizes="180x180" href="/vk-logo.png?v=7" />
