...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: '/favicon-64.png?v=11', sizes: '64x64', type: 'image/png' },
      { url: '/favicon-96.png?v=11', sizes: '96x96', type: 'image/png' },
      { url: '/favicon-128.png?v=11', sizes: '128x128', type: 'image/png' },
      { url: '/favicon.png?v=11', sizes: 'any', type: 'image/png' },
    ],
    apple: [
  ...
  return (
    <html lang="nl">
      <head>
        ...
        <link rel="icon" type="image/png" sizes="64x64" href="/favicon-64.png?v=11" />
